...
Ensure that you have installed versions of `bigdl-llm` and `bigdl-core-xe-21` that are greater than **2.5.0b20240321**. To upgrade, follow the [installation instructions](#2--install-bigdl-llm) above.
