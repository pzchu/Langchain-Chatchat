    ...
    class Config:
        schema_extra = {
            "example": {
                ...
                "source_documents": [
                    "Reference [1] 广州市单位从业的特定人员参加工伤保险办事指引.docx：\n\n\t"
    ...
    try:
        ...
        if torch.cuda.is_available():
            ...
            try:
                ...
                msg = ("If you are using macOS, it is recommended to upgrade the PyTorch version to 2.0.0 or higher "
                       "to support the timely cleanup of memory usage generated by torch.")
                logger.error(f'{e.__class__.__name__}: {msg}',
                             exc_info=e if log_verbose else None)
    except Exception:
        ...
